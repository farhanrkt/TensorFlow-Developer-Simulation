...
def solution_C3():
    ...
    class myCallback(tf.keras.callbacks.Callback):
        def on_epoch_end(self, epoch, logs={}):
            if (logs.get('val_accuracy') > 0.72 and logs.get('accuracy') > 0.72):
                print("\naccuracy and validation_accuracy > 72%")
    ...
    model.fit(train_generator, epochs=50, validation_data=(val_generator), verbose=2, callbacks=[callbacks])
